                    ...
                    onClick={() => {
                      if (result) {
                        const quizResults = {
                          score: result.score,
                          categoryScores: {
                            economic: result.categoryScores?.economic || 50,
                            cultural: result.categoryScores?.cultural || 56,
                            social: result.categoryScores?.social || 56,
                            erotic: result.categoryScores?.erotic || 89
                          },

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="lg:pr-6">
            <h1 className="font-poppins font-bold text-3xl md:text-5xl leading-tight mb-6">
              CAPITALIZA TU POTENCIAL COMO MIGRANTE DE <span className="relative">ALTA AMBICION<span className="absolute -bottom-2 left-0 w-full h-5 bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 100 20\'%3e%3cpath d=\'M0,10 C20,8 25,12 45,9 S70,5 100,11\' stroke=\'%23FF4D00\' stroke-width=\'6\' stroke-linecap=\'round\' fill=\'none\' filter=\'url(%23roughness)\'/%3e%3cdefs%3e%3cfilter id=\'roughness\'%3e%3cfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.05\' numOctaves=\'3\' result=\'noise\'/%3e%3cfeDisplacementMap in=\'SourceGraphic\' in2=\'noise\' scale=\'1.5\'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e')] bg-repeat-x bg-center opacity-100"></span></span> Y SUPERACION (MAAS)
            </h1>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="lg:pr-6">
            <h1 className="font-poppins font-bold text-3xl md:text-5xl leading-tight mb-6">
              CAPITALIZA TU POTENCIAL COMO MIGRANTE DE <span className="relative">ALTA AMBICION<span className="absolute -bottom-2 left-0 w-full h-4 bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 100 20\'%3e%3cpath d=\'M0,10 Q25,5 50,10 T100,10\' stroke=\'%23FF4D00\' stroke-width=\'3\' fill=\'none\'/%3e%3c/svg%3e')] bg-repeat-x bg-center opacity-80"></span></span> Y SUPERACION (MAAS)
            </h1>

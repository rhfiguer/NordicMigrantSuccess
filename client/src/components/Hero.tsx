        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="lg:pr-6">
            <h1 className="font-poppins font-bold text-3xl md:text-5xl leading-tight mb-6">
              CAPITALIZA TU POTENCIAL COMO MIGRANTE DE <span className="relative">ALTA AMBICION<span className="absolute -bottom-1 left-0 w-full h-6 bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 100 20\'%3e%3cpath d=\'M0,10 C30,2 70,18 100,10\' stroke=\'%23FFD700\' stroke-width=\'12\' stroke-linecap=\'round\' fill=\'none\' filter=\'url(%23brushEffect)\'/%3e%3cdefs%3e%3cfilter id=\'brushEffect\'%3e%3cfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.03\' numOctaves=\'5\' result=\'noise\'/%3e%3cfeDisplacementMap in=\'SourceGraphic\' in2=\'noise\' scale=\'3\'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e')] bg-repeat-x bg-[length:100%_100%] bg-center opacity-100"></span></span> Y SUPERACION (MAAS)
            </h1>
